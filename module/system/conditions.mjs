...
//
// Enumeration: CONFIG.statusEffects, split on the `systemEffect` flag — set by
// daggerheart.mjs when it rebuilds CONFIG.statusEffects = core effects + every
// CONFIG.DH.GENERAL.conditions() entry:
...
export async function toggle(actor, id, active) {
  ...
  try {
    ...
    console.error("[GM HUD] Toggle condition failed", err);
